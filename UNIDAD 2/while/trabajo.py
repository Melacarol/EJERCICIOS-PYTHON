...
while opcion>=0 and opcion <=10:
    ...
    if opcion==0:
        ...
        print("La cantidad de vocales es: ",contador_vocales(vocales))
    elif opcion==7:
        ...
        print("El promedio es: ",promedio(num_list))
    elif opcion==10:
        print("Ha seleccionado la opcion 10. Contador de Palabras")
        palabras=input("Ingrese una frase: ")
        print("La cantidad de palabras es: ",contador_palabras(palabras))
